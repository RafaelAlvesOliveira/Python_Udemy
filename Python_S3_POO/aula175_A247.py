...
# Por padrão a class Pessoa(object, metaclass=type), recebe
# o objeto por herança e a metaclass.
...
# Com o metódo __new__ é responsável por criar e retornar a classe, e também
# é possível executar funções dentro dessa metaclasse, para que as mesmas
# sejam carregadas, antes da classe que se deseja criar com o método __new__.
# O método __callabe__ é responsável por criar e retornar a instância.
...
# Para esse caso é necessário o key word argument metaclass=Meta
# fazendo referência a classe criada.
class Pessoa(metaclass=Meta):
    # falar = 1234
    # Essa é uma forma de burlar o sistema
